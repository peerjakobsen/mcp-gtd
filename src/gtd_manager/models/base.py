...
class GTDItem:
    ...
    def __setattr__(self, name: str, value) -> None:
        ...
        if name == 'status' and value == GTDStatus.COMPLETE and hasattr(self, 'completed_at'):
    ...
    def remove_stakeholder(self, stakeholder: 'Stakeholder', role: Optional[RACIRole] = None) -> None:
        """
